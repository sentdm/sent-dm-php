 ...
 *
 * @phpstan-type BillingContactInfoShape = array{
 *   email: string, name: string, address?: string|null, phone?: string|null
 * }
 */
final class BillingContactInfo implements BaseModel
{
    /** @use SdkModel<BillingContactInfoShape> */
    use SdkModel;
    ...
    /**
     * `new BillingContactInfo()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BillingContactInfo::with(email: ..., name: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new BillingContactInfo)->withEmail(...)->withName(...)
     * ```
     */
