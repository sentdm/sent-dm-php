...
use SentDm\TemplatesPage\Data;

/**
 * @phpstan-type TemplatesPageShape = array{data?: Data|null}
 *
 * @template TItem
 *
 * @implements BasePage<TItem>
 */
final class TemplatesPage implements BaseModel, BasePage
{
    /** @use SdkModel<TemplatesPageShape> */
    use SdkModel;
    ...
    public function __construct(
        ...
        if (is_array($items = $this->data?->offsetGet('templates'))) {
            $parsed = Conversion::coerce(new ListOf($convert), value: $items);
            // @phpstan-ignore-next-line
            $this->data->offsetSet('templates', value: $parsed);
        }
    }
    ...
    public function getItems(): array
    {
        ...
        return $this->data?->offsetGet('templates') ?? [];
    }
