...
use SentDm\Templates\TemplateCreateParams\Definition\Body\MultiChannel\Variable;

/**
 * Content that will be used for all channels (SMS and WhatsApp) unless channel-specific content is provided.
 *
 * @phpstan-import-type VariableShape from \SentDm\Templates\TemplateCreateParams\Definition\Body\MultiChannel\Variable
 *
