...
namespace SentDm\Templates\TemplateCreateParams\Definition\Body;

use SentDm\Core\Attributes\Optional;
use SentDm\Core\Attributes\Required;
use SentDm\Core\Concerns\SdkModel;
use SentDm\Core\Contracts\BaseModel;
use SentDm\Templates\TemplateCreateParams\Definition\Body\SMS\Variable;

/**
 * SMS-specific content that overrides multi-channel content for SMS messages.
 *
 * @phpstan-import-type VariableShape from \SentDm\Templates\TemplateCreateParams\Definition\Body\SMS\Variable
 *
