...
use SentDm\WebhooksPage\Data;

/**
 * @phpstan-type WebhooksPageShape = array{data?: Data|null}
 *
 * @template TItem
 *
 * @implements BasePage<TItem>
 */
final class WebhooksPage implements BaseModel, BasePage
{
    /** @use SdkModel<WebhooksPageShape> */
    use SdkModel;
    ...
    public function __construct(
        ...
        if (is_array($items = $this->data?->offsetGet('webhooks'))) {
            $parsed = Conversion::coerce(new ListOf($convert), value: $items);
            // @phpstan-ignore-next-line
            $this->data->offsetSet('webhooks', value: $parsed);
        }
    }
    ...
    public function getItems(): array
    {
        ...
        return $this->data?->offsetGet('webhooks') ?? [];
    }
