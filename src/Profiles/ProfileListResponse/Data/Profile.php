...
namespace SentDm\Profiles\ProfileListResponse\Data;

use SentDm\Core\Attributes\Optional;
use SentDm\Core\Concerns\SdkModel;
use SentDm\Core\Contracts\BaseModel;
use SentDm\Profiles\ProfileListResponse\Data\Profile\BillingContact;
use SentDm\Profiles\ProfileListResponse\Data\Profile\Brand;

/**
 * Detailed profile response for v3 API.
 *
 * @phpstan-import-type BillingContactShape from \SentDm\Profiles\ProfileListResponse\Data\Profile\BillingContact
 * @phpstan-import-type BrandShape from \SentDm\Profiles\ProfileListResponse\Data\Profile\Brand
 *
...
final class Profile implements BaseModel
{
     ...
     *
     * Kept on the wire, and never populated, because those are two different promises. Removing the key
     * changes the response's shape — a generated client loses the property and stops compiling on the next
     * regenerate, for a value that is now null for every profile in existence. Keeping it null costs a key and
     * breaks nobody, and null is the honest answer rather than a placeholder: there is no borrowing left to
     * report.
     *
     * Nothing could populate it. Migration 260813161500 dropped the column and copied each
     * borrower its own channel-provider row; its Down() says outright that the borrower-to-lender
     * pairing is not recoverable. The only surviving trace is a notes string on the copied row.
     */
