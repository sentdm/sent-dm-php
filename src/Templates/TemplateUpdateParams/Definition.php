...
namespace SentDm\Templates\TemplateUpdateParams;

use SentDm\Core\Attributes\Optional;
use SentDm\Core\Attributes\Required;
use SentDm\Core\Concerns\SdkModel;
use SentDm\Core\Contracts\BaseModel;
use SentDm\Templates\TemplateUpdateParams\Definition\AuthenticationConfig;
use SentDm\Templates\TemplateUpdateParams\Definition\Body;
use SentDm\Templates\TemplateUpdateParams\Definition\Button;
use SentDm\Templates\TemplateUpdateParams\Definition\Footer;
use SentDm\Templates\TemplateUpdateParams\Definition\Header;

/**
 * Complete definition of a message template including header, body, footer, and buttons.
 *
 * @phpstan-import-type BodyShape from \SentDm\Templates\TemplateUpdateParams\Definition\Body
 * @phpstan-import-type AuthenticationConfigShape from \SentDm\Templates\TemplateUpdateParams\Definition\AuthenticationConfig
 * @phpstan-import-type ButtonShape from \SentDm\Templates\TemplateUpdateParams\Definition\Button
 * @phpstan-import-type FooterShape from \SentDm\Templates\TemplateUpdateParams\Definition\Footer
 * @phpstan-import-type HeaderShape from \SentDm\Templates\TemplateUpdateParams\Definition\Header
 *
