...
use SentDm\Messages\MessageGetActivitiesResponse\Error;
use SentDm\Messages\MessageGetActivitiesResponse\Meta;

/**
 * Standard API response envelope for all v3 endpoints.
 *
 * @phpstan-import-type DataShape from \SentDm\Messages\MessageGetActivitiesResponse\Data
 * @phpstan-import-type ErrorShape from \SentDm\Messages\MessageGetActivitiesResponse\Error
 * @phpstan-import-type MetaShape from \SentDm\Messages\MessageGetActivitiesResponse\Meta
 *
 ...
 * }
 */
final class MessageGetActivitiesResponse implements BaseModel
{
    /** @use SdkModel<MessageGetActivitiesResponseShape> */
    use SdkModel;
