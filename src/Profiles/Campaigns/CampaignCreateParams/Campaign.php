...
namespace SentDm\Profiles\Campaigns\CampaignCreateParams;

use SentDm\Core\Attributes\Optional;
use SentDm\Core\Attributes\Required;
use SentDm\Core\Concerns\SdkModel;
use SentDm\Core\Contracts\BaseModel;
use SentDm\Profiles\Campaigns\CampaignCreateParams\Campaign\UseCase;

/**
 * Campaign data for create or update operation.
 *
 * @phpstan-import-type UseCaseShape from \SentDm\Profiles\Campaigns\CampaignCreateParams\Campaign\UseCase
 *
...
final class Campaign implements BaseModel
{
     ...
     *
     * Still required of a caller, and consulted by nothing. It named the signup path that produced the
     * campaign, was written to a column no query filters on, no TCR payload carries and no fee or status
     * decision reads, and is now defaulted at the entity instead. It stays required so that a request which
     * was valid before is still valid — dropping it would be the client-visible change, not keeping it.
     */
    #[Required]
    public string $type;
