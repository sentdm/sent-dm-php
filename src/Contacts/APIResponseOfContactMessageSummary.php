 ...
 *
 * @phpstan-import-type ContactMessageSummaryShape from \SentDm\Contacts\ContactMessageSummary
 ...
 *
 * @phpstan-type APIResponseOfContactMessageSummaryShape = array{
 *   data?: null|ContactMessageSummary|ContactMessageSummaryShape,
 *   error?: null|ErrorDetail|ErrorDetailShape,
 *   meta?: null|APIMeta|APIMetaShape,
 *   success?: bool|null,
 * }
 */
final class APIResponseOfContactMessageSummary implements BaseModel
{
    /** @use SdkModel<APIResponseOfContactMessageSummaryShape> */
    use SdkModel;
     ...
     *
     * @param ContactMessageSummary|ContactMessageSummaryShape|null $data
     * @param ErrorDetail|ErrorDetailShape|null $error
     * @param APIMeta|APIMetaShape|null $meta
     */
    public static function with(
        ContactMessageSummary|array|null $data = null,
     ...
     * @param ContactMessageSummary|ContactMessageSummaryShape|null $data
     */
    public function withData(ContactMessageSummary|array|null $data): self
    {
        $self = clone $this;
        $self['data'] = $data;
