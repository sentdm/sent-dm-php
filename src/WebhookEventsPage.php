...
use SentDm\WebhookEventsPage\Data;

/**
 * @phpstan-type WebhookEventsPageShape = array{data?: Data|null}
 *
 * @template TItem
 *
 * @implements BasePage<TItem>
 */
final class WebhookEventsPage implements BaseModel, BasePage
{
    /** @use SdkModel<WebhookEventsPageShape> */
    use SdkModel;
    ...
    public function __construct(
        ...
        if (is_array($items = $this->data?->offsetGet('events'))) {
            $parsed = Conversion::coerce(new ListOf($convert), value: $items);
            // @phpstan-ignore-next-line
            $this->data->offsetSet('events', value: $parsed);
        }
    }
    ...
    public function getItems(): array
    {
        ...
        return $this->data?->offsetGet('events') ?? [];
    }
