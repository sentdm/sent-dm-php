...
use SentDm\Templates\TemplateUpdateParams\Definition\Button\Props;

/**
 * Interactive button in a message template.
 *
 * @phpstan-import-type PropsShape from \SentDm\Templates\TemplateUpdateParams\Definition\Button\Props
 *
