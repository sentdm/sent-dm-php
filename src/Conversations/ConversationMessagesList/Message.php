...
namespace SentDm\Conversations\ConversationMessagesList;

use SentDm\Conversations\ConversationMessagesList\Message\Event;
use SentDm\Conversations\ConversationMessagesList\Message\MessageBody;
