...
use SentDm\ConversationsPage\Data;
...
/**
 * @phpstan-type ConversationsPageShape = array{data?: Data|null}
 *
 * @template TItem
 *
 * @implements BasePage<TItem>
 */
final class ConversationsPage implements BaseModel, BasePage
{
    /** @use SdkModel<ConversationsPageShape> */
    use SdkModel;
    ...
    public function __construct(
        ...
        if (is_array($items = $this->data?->offsetGet('messages'))) {
            $parsed = Conversion::coerce(new ListOf($convert), value: $items);
            // @phpstan-ignore-next-line
            $this->data->offsetSet('messages', value: $parsed);
        }
    }
    ...
    public function getItems(): array
    {
        ...
        return $this->data?->offsetGet('messages') ?? [];
    }
