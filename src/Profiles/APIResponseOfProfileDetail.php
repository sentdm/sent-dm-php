 ...
 * }
 */
final class APIResponseOfProfileDetail implements BaseModel
{
    /** @use SdkModel<APIResponseOfProfileDetailShape> */
    use SdkModel;
     ...
     * @param ProfileDetail|ProfileDetailShape|null $data
     */
    public function withData(ProfileDetail|array|null $data): self
    {
        $self = clone $this;
        $self['data'] = $data;
