 ...
 *
 * @phpstan-type APIResponseContactShape = array{
 *   data?: null|Contact|ContactShape,
 *   error?: null|APIError|APIErrorShape,
 *   meta?: null|APIMeta|APIMetaShape,
 *   success?: bool|null,
 * }
 */
final class APIResponseContact implements BaseModel
{
    /** @use SdkModel<APIResponseContactShape> */
    use SdkModel;
     ...
     * @param Contact|ContactShape|null $data
     */
    public function withData(Contact|array|null $data): self
    {
        $self = clone $this;
        $self['data'] = $data;
