 ...
 *   data?: list<BrandWithKYC|BrandWithKYCShape>|null,
...
final class BrandListResponse implements BaseModel
{
     ...
     *
     * @var list<BrandWithKYC>|null $data
     */
    #[Optional(list: BrandWithKYC::class, nullable: true)]
    public ?array $data;
     ...
     *
     * @param list<BrandWithKYC|BrandWithKYCShape>|null $data
